...
const frost_hitbox_load = preload("res://Magie/frost_hitbox.tscn")
...
func _on_Timer_timeout():
	var hit_box = frost_hitbox_load.instance()
	var hit_box_up = frost_hitbox_load.instance()
	var hit_box_down = frost_hitbox_load.instance()
	if TEAM == "blue":
		hit_box.TEAM = "blue"
